...
It is very easy to analyze a C/C++/Objective-C project on Bitbucket with SonarCloud:
...
- https://sonarcloud.io/documentation/getting-started/bitbucket-cloud/[Getting started with Bitbucket Cloud]
